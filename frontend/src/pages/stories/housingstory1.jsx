...
const HousingStory1 = () => {
  const story = {
    ...
    fullStory: {
      introduction: "Sarah M.'s journey is one of transformation, resilience, and hope. Through the support of PCLA's programs and services, she has found stability, community, and a renewed sense of purpose.",
      paragraph1: "Like many who come to PCLA, her path wasn't linear. There were setbacks and challenges along the way. But with consistent support, access to resources, and the belief that recovery is possible, she began to see change. Small victories turned into larger milestones, and what once seemed impossible became reality.",
      paragraph2: "The turning point came when she realized she wasn't alone in her struggle. Being surrounded by peers who understood her experiences, and staff who believed in her potential, created an environment where healing could happen. Access to stable housing provided the foundation, but it was the sense of belonging that truly made the difference.",
      paragraph3: "Today, her life looks dramatically different. She has routines, relationships, and goals for the future. She's reconnected with family members, pursued education or employment opportunities, and most importantly, she's reclaimed her sense of self-worth. Her mental health challenges haven't disappeared, but she now has the tools, support, and confidence to manage them.",
      paragraph4: "Looking back, she can see how far she's come. The person who first walked through PCLA's doors feels like a different lifetime ago. While the journey continues—recovery is ongoing—she now approaches each day with hope and confidence. She's learned that having a mental illness doesn't define her, and that with the right support, anything is possible.",
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Banner with Summary Overlay */}
