  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-3 gap-12 items-start">
            <div className="md:col-span-1">
              <div className="aspect-[3/4] w-full overflow-hidden rounded-3xl border-4 border-gray-200 shadow-xl">
                <img 
                  src="https://images.pexels.com/photos/3785079/pexels-photo-3785079.jpeg?w=600" 
                  alt="Simi Rajput"
            ...
            <div className="md:col-span-2">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Simi Rajput</h1>
              <p className="text-2xl text-[#86a873] font-semibold mb-6">Secretary</p>
              ...
              <div className="flex space-x-4 mb-8">
                ...
                <a href="mailto:simi-rajput@pclaservices.ca" className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#336f99] text-white hover:bg-[#86a873] transition-colors">
                  <Mail className="w-5 h-5" />
                </a>
              </div>

              <p className="text-xl text-gray-700 leading-relaxed">
                Simi Rajput serves as Secretary of PCLA's Board of Directors, ensuring effective governance and record-keeping.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">About Simi Rajput</h2>
