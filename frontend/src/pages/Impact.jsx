...
export const Impact = () => {
  const metrics = [
    ...
    { dimension: 'Housing', stat: '358', label: 'clients placed and supported across our programs and locations.', icon: HomeIcon, color: 'bg-[#336f99]' },
    { dimension: 'Health', stat: '125,556', label: 'hours of direct care provided', icon: Users, color: 'bg-[#86a873]' },
    { dimension: 'Purpose', stat: '87%', label: 'of clients feel optimistic about their recovery journeys.', icon: TrendingUp, color: 'bg-[#f26d2d]' },
    ...
    { dimension: 'Autonomy', stat: '89%', label: 'of clients note they are very satisfied with thePCLA staff support.', icon: TrendingUp, color: 'bg-[#86a873]' }
  ];
